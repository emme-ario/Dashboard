...
function switchLight1() {
    ...
    sensors[0].value = !sensors[0].value        
...
function switchLight2() {
    ...
    sensors[1].value = !sensors[1].value
    sensors[1].toggleSensor()
    printPopupData(1)
    printData()
}

function changeNukeState() {
    const nuke = document.getElementById("nuke")
    nuke.classList.toggle("nuke")

    sensors[2].value = !sensors[2].value
...
function changeDoorState() {
    ...
    sensors[3].value = !sensors[3].value
